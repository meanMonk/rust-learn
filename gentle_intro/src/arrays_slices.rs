...
fn slice_one() {
    ...
    println!("first value {} isNone {} isSome {} ", first_of_slice.unwrap(), first_of_slice.is_none(), first_of_slice.is_some());
    ...
    println!("last values {last} shortLast {short_last} isNone {} isSome {}", last_of_slice.is_none(), last_of_slice.is_some());
}
